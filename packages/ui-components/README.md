...
- For portal-based UI inside the Trace widget, render into the widget portal container instead of `document.body`. In practice, package authors typically pair this package with `useWidgetPortalContainer()` from `@react-trace/core`.
